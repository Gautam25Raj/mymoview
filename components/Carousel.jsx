...
const Carousel = ({ data, loading }) => {
  ...
  const SkelitonItem = () => {
    return (
      <div>
        <div className="h-64 md:h-80 aspect-1/1.5 rounded-md mb-7 skeleton"></div>
        <div className="textBlock">
          <div className="w-full h-5 mb-2 skeleton"></div>
  ...
  return (
    <div className="mb-12 relative">
      ...
      <div className="right-4 text-white absolute top-2/4 -translate-y-1/2 cursor-pointer opacity-60 z-20 hidden md:block md:hover:opacity-100 bg-black rounded-full p-2">
        <ArrowRightIcon
          className="w-8 h-8"
